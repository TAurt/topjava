...
<section>
    ...
    <hr/>
    <a href="${pageContext.request.contextPath}/meals/addmeal?action=create"><spring:message code="addMeal"/></a>
    <br><br>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExcess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="${pageContext.request.contextPath}/meals/update?action=update&id=${meal.id}"><spring:message code="update"/></a></td>
                <td><a href="${pageContext.request.contextPath}/meals/delete?action=delete&id=${meal.id}"><spring:message code="delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
